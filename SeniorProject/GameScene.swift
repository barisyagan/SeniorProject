...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func startCloudMovements() {
        ...
        let spawnLeftRepeatedSequence = SKAction.repeat(spawnLeftSequence, count: 5)
        let spawnTopLeftRepeatedSequence = SKAction.repeat(spawnTopLeftSequence, count: 5)
        let spawnTopRepeatedSequence = SKAction.repeat(spawnTopSequence, count: 10)
        let spawnTopRightRepeatedSequence = SKAction.repeat(spawnTopRightSequence, count: 5)
        let spawnRightRepeatedSequence = SKAction.repeat(spawnRightSequence, count: 5)
